...
!             com = 0
!             call center_of_mass(com, cent)
!             do ic=1,ncent
!                write(ounit, *)'COM ',(com(k,ic), k=1,3)
!             enddo
          else
...
!             enddo
      ...
      subroutine center_of_mass(com, vector)
      ...
      integer :: ic, k
      real(dp), dimension(3,ncent) :: vector
      real(dp), dimension(3) :: com

      do ic = 1,ncent
         do k = 1,3
            com(k) = com(k) + vector(k, ic) / ncent
         enddo
      enddo
