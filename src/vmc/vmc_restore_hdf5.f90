module vmc_restore_hdf5_mod
        ...
        character(:), allocatable       ::  date, time, read_author
        character(:), allocatable       ::  git_branch, git_commit
        character(:), allocatable       ::  compiler, compiler_version
        character(:), allocatable       ::  arch, hdf5_version
        ...
        call hdf5_read(file_id, group_id, "tjfcum", tjfcum(1:nstates))
        ...
        call hdf5_read(file_id, group_id, "tjfcm2", tjfcm2(1:nstates))
        ...
        if (ioptwf.ne.0 .and.  .not.(ioptci.eq.0.or.method.eq.'sr_n'.or.method.eq.'lin_d')) then
                ...
                call hdf5_read(file_id, group_id, "ci_o_cum", ci_o_cum(1:nciterm))
                call hdf5_read(file_id, group_id, "ci_oe_cum", ci_oe_cum(1:nciterm,1:nciterm))
                call hdf5_read(file_id, group_id, "ci_oe_cm2", ci_oe_cm2(1:nciterm,1:nciterm))
                call hdf5_read(file_id, group_id, "ci_oo_cum", ci_oo_cum(1:matdim))
                call hdf5_read(file_id, group_id, "ci_oo_cm2", ci_oo_cm2(1:matdim))
                call hdf5_read(file_id, group_id, "ci_ooe_cum", ci_ooe_cum(1:matdim))
                call hdf5_group_close(group_id)
        ...
        if (.not. (ioptjas.eq.0.or.ioptci.eq.0)) then
                ...
                call hdf5_read(file_id, group_id, "dj_o_ci", dj_o_ci(1:nparmj,1:nciterm))
                call hdf5_read(file_id, group_id, "dj_oe_ci", dj_oe_ci(1:nparmj,1:nciterm))
                call hdf5_read(file_id, group_id, "dj_de_ci", dj_de_ci(1:nparmj,1:nciterm))
                call hdf5_read(file_id, group_id, "de_o_ci", de_o_ci(1:nparmj,1:nciterm))
                call hdf5_group_close(group_id)
